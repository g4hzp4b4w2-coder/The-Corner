...
export function getChatReply({ messages, images, poseMetrics, videoType, caption, profile, entries, lang }) {
  return callApi("/api/coach-chat", { messages, images, poseMetrics, videoType, caption, profile, entries, lang });
}
